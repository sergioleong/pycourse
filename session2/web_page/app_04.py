...
from chatbot_04 import get_ollama_response
...
def chat():
    ...
    """
    return render_template('chat_04.html', username=session.get('username'))
...
def api_chat():
    ...
    # Call the get_ollama_response function from the chatbot module
    ai_response_content, status_code, error_message = get_ollama_response(user_message)
    if error_message:
