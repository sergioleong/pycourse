...
from models_09 import get_db_session, close_db_session, User, engine, Base, Chat, ChatMessage
...
def chat():
    ...
    return render_template('chat_09.html',
                           username=username,
...
def archived_chats():
    ...
    return render_template('archived_chats_10.html',
                           username=session.get('username'),
